...
omega3 <- 2
omega4 <- 0.4
Sv20<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega1),iniv,M0,acqdistn,dt,500)
Sv15<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega2),iniv,M0,acqdistn,dt,500)
Sv10<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega3),iniv,M0,acqdistn,dt,500)
Sv05<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega4),iniv,M0,acqdistn,dt,500)
