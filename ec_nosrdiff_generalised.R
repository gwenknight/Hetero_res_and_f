...
omega4 <- 0.4
kk <- 500
Sv20<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega1,kk),iniv,M0,acqdistn,dt)
Sv15<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega2,kk),iniv,M0,acqdistn,dt)
Sv10<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega3,kk),iniv,M0,acqdistn,dt)
Sv05<-ec_srs_funcf_mean_varsr(tsteps,home, c(omega4,kk),iniv,M0,acqdistn,dt)
